<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <!--end::Brand-->
    <div class="toolbar" style="background-color:#83BD75;">
        <!--begin::Toolbar-->
            ...
            <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                        ...
                        <img src="{{asset('img/avatars/admin.png')}}" alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    @php
                                        $email = "";
                                    @endphp
                                    @if(Auth::user()->id_operator != null && Auth::user()->nip == null && Auth::user()->nisn == null)
                                        @php $email = Auth::user()->operator->email; @endphp
                                    @elseif(Auth::user()->id_operator == null && Auth::user()->nip != null && Auth::user()->nisn == null)
                                        @php $email = Auth::user()->guru->email; @endphp
                                    @elseif(Auth::user()->id_operator == null && Auth::user()->nip == null && Auth::user()->nisn != null)
                                        @php $email = Auth::user()->siswa->email; @endphp
                                    @else                                        
                                        @php $email = ""; @endphp
                                    @endif
                        ...
                        @php
                            ...
                            if (Auth::user()->role == 'o') {
                                ...
                                $profile = route('guru.profile.index');
                            } elseif (Auth::user()->role == 's') {
                                $profile = route('siswa.profile.index');
                            }
                        @endphp
