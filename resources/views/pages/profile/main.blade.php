                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group row p-5">
                                            ...
                                            <div class="col-sm-10">
                                                @if(Auth::user()->role=='o')
                                                    <input class="form-control" type="text" name="id_operator" id="id_operator" value="{{$data->id_operator}}">
                                                @elseif(Auth::user()->role=='g')
                                                    <input class="form-control" type="text" name="nip" id="nip" value="{{$data->nip}}">
                                                @else
                                                    <input class="form-control" type="text" name="nisn" id="nisn" value="{{$data->nisn}}">
                                                @endif
                                            </div>
                                        </div> 
                                    </div> 
