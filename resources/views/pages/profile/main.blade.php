                        ...
                        <form id="form-profile">
                            <div class="card-body pb-0">
                                ...
                                <div class="min-w-150px mt-10 text-end">
                                    ...
                                    $profile = '';
                                    if (Auth::user()->role == 'o') {
                                        $profile = route('admin.profile.cpassword');
                                    } elseif (Auth::user()->role == 'g') {
                                        $profile = route('guru.profile.cpassword');
                                    } elseif (Auth::user()->role == 's') {
                                        $profile = route('siswa.profile.cpassword');
                                    }
                                @endphp
                                    <button class="btn btn-primary" id="tombol_simpan" onclick="handle_save_password('#tombol_simpan','#form-profile','{{$profile}}','POST');">Kirim</button>
