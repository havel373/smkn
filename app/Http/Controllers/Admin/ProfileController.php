...
class ProfileController extends Controller
{
    ...
    public function cprofile(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'email' => 'required|max:255|unique:siswa,email,'.Auth::user()->id_operator.',id_operator',
            'id_operator' => 'numeric|nullable|unique:siswa,id_operator,'.Auth::user()->id_operator.',id_operator','|unique:pengguna,id_operator,'.Auth::user()->id_operator.',id_operator',
        ]);
        if ($validator->fails()) {
